...
(function () {
  ...
  nameSpace.initAnimation = function () {
    ...
    timeline
      .to('#logo', 0.1, { autoAlpha: 1 }, '-=0.3')
      .to('#logo', 0.1, { autoAlpha: 0 }, '+=1.3')

      .to('#copy-1', 0.1, { autoAlpha: 1 })

      .to('#copy-1', 0.1, { autoAlpha: 0 }, '+=2.25')

      .to('#copy-2', 0.1, { autoAlpha: 1 })

      .to('#copy-2', 0.1, { autoAlpha: 0 }, '+=2.25')

      .to('#copy-3', 0.1, { autoAlpha: 1 })
