...
(function () {
  ...
  nameSpace.initAnimation = function () {
    ...
    timeline
      ...
      .to('#bubble-1', 0.5, { scale: 1, autoAlpha: 1, ease: 'bubbleIn' })
      .to('#copy-effect-2', 0.3, { autoAlpha: 1 }, '-=0.3')
      .to('#copy-2', 0.5, { autoAlpha: 1 }, '-=0.2')

      .to('#copy-effect-2', 0.2, { autoAlpha: 0, ease: 'bubbleIn' }, '+=2.2')
      .to('#copy-2', 0.1, { autoAlpha: 0 }, '-=0.1')
      .to(
        '#bubble-1',
        0.4,
        { scale: 0, autoAlpha: 0, ease: Power4.easeIn },
      ...
      .to('#copy-3', 0.3, { autoAlpha: 1 })
      .to(
        '#bubble-2',
        0.7,
        { scale: 1, autoAlpha: 1, ease: 'bubbleIn' },
        '+=1.25'
      )
      .to('#copy-effect-3', 0.5, { autoAlpha: 1 }, '-=0.3')

      .to(['#cta'], 0.5, { autoAlpha: 1, ease: Cubic.easeInOut }, '+=1');
  };
